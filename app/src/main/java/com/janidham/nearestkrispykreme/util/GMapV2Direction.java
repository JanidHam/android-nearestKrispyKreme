...
public class GMapV2Direction extends AsyncTask<LatLng,Void,Document>{
	...
	public GMapV2Direction(LatLng sl, LatLng el, String mode, GoogleMap map) {
		this.start = sl;
		this.end = el;
		this.m = mode;
        this.map = map;
	...
	protected void onPostExecute(Document resultdoc) {
        ...
        ArrayList<LatLng> lines = getDirection(resultdoc);

        map.addPolyline(new PolylineOptions()
                .addAll(lines).color(Config.COLORLINESMAP)
        );
	}
